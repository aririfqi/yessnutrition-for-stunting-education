...
import 'package:yess_nutrition/data/models/edustunting_models/edu_stunting_model.dart';
import 'package:yess_nutrition/presentation/pages/check_pages/list_mpasi.dart';
import 'package:yess_nutrition/presentation/pages/edukasi_ibuHamil/daftar_menu.dart';
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          switch (settings.name) {
            ...
            case menuEdukasiIbuHamil:
              return MaterialPageRoute(
                builder: (_) => const DaftarMenu(),
                settings: settings,
              );
            case mpasirecipe:
              return MaterialPageRoute(
                builder: (_) => const ListMpasi(),
                settings: settings,
              );
            case detailEduRoute:
              final educationStunting = settings.arguments as EducationStunting;

              return MaterialPageRoute(
                builder: (_) =>
                    DetailEducationPage(educationStunting: educationStunting),
                settings: settings,
              );
