...
const mpasirecipe = '/mpasi-recipe';
...
const detailEduRoute = '/detail_edu_page';
const listEduRoute = '/education_list_page';
const menuEdukasiIbuHamil = '/menu_edukasi_ibu_hamil';
