...
import 'package:yess_nutrition/presentation/pages/edukasi_stunting/edu_list_page.dart';
...
import '../edukasi_ibuHamil/daftar_menu.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    _pages.addAll([
      ...
      const DaftarMenu(),
      const EducationStuntingListPage(),
    ]);
  }
